...
class Model_Pusher:
    ...
    def initiate_model_pusher(self)->ModelPusherArtifact:
        try:
            ...
            # saved model dir
            logging.info("Saving model into saved model directory")
            ...
            model_pusher_artifact = ModelPusherArtifact(pusher_model_dir=self.model_pusher_config.pusher_model_dir, saved_moodel_dir=self.model_pusher_config.saved_model_dir)
