...
class Data_Transformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        This function will be used to replacing missing value with simple_imputer
        and handling outlier using robust scaler
        =========================================================================
        return Pipeline
        """
        try:
    ...
    def initiate_data_transformation(self)->artifact_entity.DataTransformationArtifact:
        try:
            ...
            utils.sav_numpy_array_data(file_path=self.data_transformation_config.transform_test_path, array=test_arr)
